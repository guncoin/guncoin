...
const char* BITCOIN_REQUEST_MIMETYPE = "application/guncoin-paymentrequest";
const char* BITCOIN_PAYMENTACK_MIMETYPE = "application/guncoin-paymentack";
const char* BITCOIN_PAYMENTACK_CONTENTTYPE = "application/guncoin-payment";
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
                ...
                emit message(tr("URI handling"),
                    tr("URI can not be parsed! This can be caused by an invalid Guncoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
