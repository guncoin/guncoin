    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:  guncoin-qt [command-line options]                     \n";
...
All the Gun in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 100, 1,000, 10,000, 100,000 and 1,000,000 GUN.</li> \
