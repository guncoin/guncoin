...
std::string CInv::GetCommand() const
{
    ...
    case MSG_TXLOCK_REQUEST:
        return cmd.append(NetMsgType::TXLOCKREQUEST);
    case MSG_TXLOCK_VOTE:
        return cmd.append(NetMsgType::TXLOCKVOTE);
    case MSG_MASTERNODE_PAYMENT_VOTE:
        return cmd.append(NetMsgType::MASTERNODEPAYMENTVOTE);
    case MSG_MASTERNODE_PAYMENT_BLOCK:
        return cmd.append(NetMsgType::MASTERNODEPAYMENTBLOCK);
    case MSG_MASTERNODE_ANNOUNCE:
        return cmd.append(NetMsgType::MNANNOUNCE);
    case MSG_MASTERNODE_PING:
        return cmd.append(NetMsgType::MNPING);
    case MSG_DSTX:
        return cmd.append(NetMsgType::DSTX);
    case MSG_MASTERNODE_VERIFY:
        return cmd.append(NetMsgType::MNVERIFY);
    default:
