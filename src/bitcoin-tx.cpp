...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s guncoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  guncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded guncoin transaction") + "\n" +
              "  guncoin-tx [options] -create [commands]   " + _("Create hex-encoded guncoin transaction") + "\n" +
              "\n";
