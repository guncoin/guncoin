...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Guncoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed.guncoin.info", "seed.guncoin.info"},
    {"seed2.guncoin.info", "seed2.guncoin.info"},
    {"seed3.guncoin.info", "seed3.guncoin.info"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Guncoin is probably already running."), addrBind.ToString().c_str());
        else
