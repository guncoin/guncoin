...
void CPrivateSend::InitStandardDenominations()
{
    ...
    /* Denominations
        ...
        For example:
        1000 GUN + 1000000  == (100 GUN + 100000) * 10
    */
...
bool CPrivateSend::IsCollateralValid(const CTransaction& txCollateral)
{
...

    {
        ...
        if(!AcceptToMemoryPool(mempool, validationState, MakeTransactionRef(txCollateral), NULL, NULL, false, maxTxFee, true)) {
