...
const char * const BITCOIN_CONF_FILENAME = "guncoin.conf";
const char * const BITCOIN_PID_FILENAME = "guncoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Guncoin";
#else
    // Unix
